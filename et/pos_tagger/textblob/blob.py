...
from .decorators import cached_property, requires_nltk_corpus
...
from .base import (BaseNPExtractor, BaseTagger, BaseTokenizer,
                       BaseSentimentAnalyzer, BaseParser)
from .np_extractors import FastNPExtractor
from .taggers import NLTKTagger
from .tokenizers import WordTokenizer, sent_tokenize, word_tokenize
    ...
    def pos_tags(self):
        ...
        if isinstance(self, TextBlob):
            ...
            return [(Word(word, pos_tag=t), unicode(t))
                    ...
                    #if PUNCTUATION_REGEX.match(unicode(t))]
